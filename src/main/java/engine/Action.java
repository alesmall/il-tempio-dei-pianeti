 ...
 * utilizzare, al posto di un parametro di tipo Action, l'espressione lambda: p -> game.doSomething()
 * vuol dire "creare un oggetto che implementa l'interfaccia Action,
